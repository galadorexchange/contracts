...
import "../lm-pool/interfaces/IGaladorV3LmPool.sol";

contract GaladorV3Pool is IGaladorV3Pool {
    ...
    /// @inheritdoc IGaladorV3PoolImmutables
    ...
    /// @inheritdoc IGaladorV3PoolState
    ...
    // liquidity mining
    IGaladorV3LmPool public lmPool;
    ...
    function balance0() private view returns (uint256) {
        (bool success, bytes memory _data) = token0.staticcall(
            abi.encodeWithSelector(
                IERC20Minimal.balanceOf.selector,
                address(this)
            )
        );
        require(success && _data.length >= 32);
    ...
    function balance1() private view returns (uint256) {
        (bool success, bytes memory _data) = token1.staticcall(
            abi.encodeWithSelector(
                IERC20Minimal.balanceOf.selector,
                address(this)
            )
    ...
    /// @inheritdoc IGaladorV3PoolDerivedState
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IGaladorV3SwapCallback(msg.sender).galadorV3SwapCallback(
                amount0,
                amount1,
                _data
            );
    ...
    function flash(
        ...
        IGaladorV3FlashCallback(msg.sender).galadorV3FlashCallback(
            fee0,
            fee1,
            _data
        );
    ...
    /// @inheritdoc IGaladorV3PoolOwnerActions
    ...
    function setLmPool(
        ...
        lmPool = IGaladorV3LmPool(_lmPool);
