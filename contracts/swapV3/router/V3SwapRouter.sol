...
/// @title Galador V3 Swap Router
/// @notice Router for stateless execution of swaps against Galador V3
    ...
    ReentrancyGuard
{
    ...
    function exactInputSingle(
        ...
        if (params.amountIn == Constants.CONTRACT_BALANCE) {
            hasAlreadyPaid = true;
            params.amountIn = IERC20Ozep342(params.tokenIn).balanceOf(
                address(this)
            );
        }
    ...
    function exactInput(
        ...
        if (params.amountIn == Constants.CONTRACT_BALANCE) {
            ...
            params.amountIn = IERC20Ozep342(tokenIn).balanceOf(address(this));
        }
