...
import "../../core/interfaces/callback/IGaladorV3SwapCallback.sol";
...
contract QuoterV2 is
    IQuoterV2,
    IGaladorV3SwapCallback,
    PeripheryImmutableState
{
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IGaladorV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IGaladorV3Pool) {
        return
            IGaladorV3Pool(
    ...
    /// @inheritdoc IGaladorV3SwapCallback
    function galadorV3SwapCallback(
        ...
        IGaladorV3Pool pool = getPool(tokenIn, tokenOut, fee);
