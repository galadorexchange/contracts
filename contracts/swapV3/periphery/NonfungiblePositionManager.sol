...
/// @title NFT positions
/// @notice Wraps Galador V3 positions in the ERC721 non-fungible token interface
    ...
    SelfPermit
{
    ...
    constructor(
        ...
        ERC721Permit("Galador V3 Positions NFT-V1", "GLDR-V3-POS", "1")
        PeripheryImmutableState(_deployer, _factory, _WETH9, _codeHash_)
    {
    ...
    {
        require(msg.value >= params.amount0Desired, "msg.value < params.amount0Desired");
